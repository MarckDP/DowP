...
class NormalPopoverContent(QFrame):
    ...
    def _ask_and_download(self, model_name: str, model_info: dict):
        ...
        if model_id in self._downloads or is_normal_model_installed(model_info):
            self._update_status()
            return
        ...
        worker = ModelDownloadWorker(model_id, download_normal_model, model_info, parent=self)
